...
<div style="
    ...
    text-align: center;
">
    <h2 style="color:#ffd966; text-align:center; margin-bottom:0.4rem; font-size:1.4rem; letter-spacing:0.5px;">Classi AI &mdash; Universal Voice Filter &amp; Correction</h2>
    <p style="font-size:1.2rem; line-height:1.4; margin:0.2rem 0; font-weight:600; color:#00ffff;">
