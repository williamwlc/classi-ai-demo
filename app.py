...
# About Content with IELTS/TOEFL integration
st.markdown("""
<div class="info-box">
...
<p>Beyond enterprise infrastructure, Classi's consumer SaaS platform is <strong>equally disruptive</strong>. Engineered to serve the over <strong>1 billion non-native English learners globally</strong>, it delivers a comprehensive suite of advanced features, <strong>some first in the market</strong>—including our flagship "Let's Talk" feature with simulated IELTS/TOEFL scoring rubrics, customizable AI personas, and precision pronunciation guidance across all four core language skills. By leveraging our Universal Fluency Layer in these highly demanding consumer scenarios, our ecosystem doesn't just compete with legacy EdTech tools—it renders dictionaries, translation apps, and conventional language learning platforms obsolete.</p>
</div>
""", unsafe_allow_html=True)

# Voice Recording Section (Buttons restored to original text)
